...
- [ ] Explain what a token is used for.
  ...
  Tokens are used for authentication, e.g., gives access to protected routes. A token is supplied by the server and saved in local storage. 

- [ ] What steps can you take in your web apps to keep your data secure?

  Use protected routes to make sure that only users with proper authentication can access data.

- [ ] Describe how web servers work.

  Web servers store and then provide (upon HTTP requests from user) files to form web pagges for users to access.  
